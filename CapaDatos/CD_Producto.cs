    ...
    public class CD_Producto
    {
        public List<Producto> Listar()
        {
            ...
            try
            {
                ...
                {
                    StringBuilder sb = new StringBuilder();//Para concatenar cadenas de texto en un solo string

                    sb.Append("SELECT p.IdProducto, p.Nombre, p.Descripcion, ");
                    sb.Append("m.IdMarca, m.Descripcion AS DesProducto, ");
                    sb.Append("c.IdCategoria, c.Descripcion AS DesCategoria, ");
                        ...
                        while (dr.Read())
                        {
                            lista.Add(new Producto()
                            {
                                ...
                                oMarca = new Marca()
                                {
                                    ...
                                    Descripcion = dr["DesProducto"].ToString()
                                },
